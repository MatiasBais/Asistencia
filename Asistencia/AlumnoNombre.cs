...
{
    public partial class AlumnoNombre : Form
    {
        public AlumnoNombre()
        {
            InitializeComponent();
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            string consulta = "select Nombre, Curso, Telefono, DNI from alumno where Nombre LIKE '%" + textBox1.Text + "%' and curso !='Antiguo Alumno' and curso !=''";
        ...
        private void AlumnoNombre_Load(object sender, EventArgs e)
        {
            MySqlConnection cnn = new MySqlConnection(cadenaconexion());
